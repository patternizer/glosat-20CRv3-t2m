...
#------------------------------------------------------------------------------
# PROGRAM: calc_sd_20CRv3_t2m_all_years.py
#------------------------------------------------------------------------------
# Version 0.2
# 9 March, 2021
# Michael Taylor
...
def make_shell_command(year):
    ...
    job_cdo = 'cdo ensstd1 {0}/TMP2m.{0}.mnmean_mem0* {0}_ensemble_sd.nc\n'.format(year)
#   job_nco = 'ncea -y rmssdn {0}*_ensemble_anomaly.nc {0}_ensemble_sd.nc\n'.format(year)
...
if __name__ == "__main__":
    ...
    for year in range(year1,year2):
        file_out = '{0}_ensemble_sd.nc'.format(year)                       
