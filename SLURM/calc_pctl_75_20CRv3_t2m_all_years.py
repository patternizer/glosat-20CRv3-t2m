...
#------------------------------------------------------------------------------
# PROGRAM: calc_pctl_75_20CRv3_t2m_all_years.py
#------------------------------------------------------------------------------
# Version 0.1
# 9 March, 2021
# Michael Taylor
...
def make_shell_command(year):
    ...
    job_id = 'SBATCH --job-name=pctl_75.{0}\n'.format(year)        
#   job_tar = 'tar xvf ensemble-tar/TMP2m_{0}_mnmean.tar\n'.format(year) 
    job_cdo = 'cdo enspctl,75 {0}/TMP2m.{0}.mnmean_mem0* {0}_ensemble_pctl_75.nc\n'.format(year) 
    job_file = 'run.{0}.pctl_75.sh'.format(year)
...
if __name__ == "__main__":
    ...
    for year in range(year1,year2):
        file_out = '{0}_ensemble_pctl_75.nc'.format(year)                       
