...
#------------------------------------------------------------------------------
# PROGRAM: calc_mean_20CRv3_t2m_all_years.py
#------------------------------------------------------------------------------
# Version 0.1
# 5 March, 2021
# Michael Taylor
...
#   job_nco = 'ncea {0}/TMP2m.{0}.mnmean_mem0* {0}_ensemble_mean.nc\n'.format(year) 
    job_cdo = 'cdo ensmean {0}/TMP2m.{0}.mnmean_mem0* {0}_ensemble_mean.nc\n'.format(year) 
...
if __name__ == "__main__":
    ...
    for year in range(year1,year2):
        file_out = '{0}_ensemble_mean.nc'.format(year)                       
